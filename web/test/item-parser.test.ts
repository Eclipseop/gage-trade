    ...
    affix: [
      {
        ...
        regex: /^(?:an|\+?\d+(?:\.\d+)?) to maximum Life(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
    roll: 212,
    ...
    affix: [
      {
        ...
        regex:
          /^(?:an|\+?\d+(?:\.\d+)?) to Accuracy Rating(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
  };
    ...
    affix: [
      {
        ...
        regex:
          /^(?:an|\+?\d+(?:\.\d+)?)% (increased|reduced) Elemental Damage(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
  };
    ...
    affix: [
      {
        ...
        regex:
          /^(?:an|\+?\d+(?:\.\d+)?)% (increased|reduced) Rarity of Items found(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
  };
    ...
    affix: [
      {
        ...
        regex:
          /^Minions have (?:an|\+?\d+(?:\.\d+)?)% (increased|reduced) maximum Life(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
    roll: 28,
    ...
    affix: [
      {
        type: "EXPLICIT",
        regex:
          /^Allies in your Presence deal (?:an|\+?\d+(?:\.\d+)?) to (?:an|\+?\d+(?:\.\d+)?) additional Attack Lightning Damage(s?)( in your Maps)?$/,
    ...
    affix: [
      {
        ...
        regex:
          /^Allies in your Presence have (?:an|\+?\d+(?:\.\d+)?) to Accuracy Rating(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
    roll: 67,
    ...
    affix: [
      {
        ...
        regex:
          /^Allies in your Presence have (?:an|\+?\d+(?:\.\d+)?)% (increased|reduced) Attack Speed(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
    roll: 16,
    ...
    affix: [
      {
        ...
        regex:
          /^Adds (?:an|\+?\d+(?:\.\d+)?) to (?:an|\+?\d+(?:\.\d+)?) Fire damage to Attack(s?)( in your Maps)?$/,
        type: "IMPLICIT",
      },
    ],
    roll: 4,
    ...
    affix: [
      {
        ...
        rawText:
          "When a Party Member in your Presence Casts a Spell, you\nSacrifice 20% of Mana and they Leech that Mana",
        regex:
          /^When a Party Member in your Presence Casts a Spell, you\nSacrifice (?:an|\+?\d+(?:\.\d+)?)% of Mana and they Leech that Mana(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
    roll: 20,
    ...
    affix: [
      {
        ...
        regex:
          /^(?:an|\+?\d+(?:\.\d+)?)% to Critical Damage Bonu(s?)( in your Maps)?$/,
        type: "ENCHANT",
      },
    ],
  };
    ...
    affix: [
      {
        ...
        regex: /^(?:an|\+?\d+(?:\.\d+)?) Charm Slot(s?)( in your Maps)?$/,
        type: "EXPLICIT",
      },
    ],
  };
