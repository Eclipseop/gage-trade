...
const CONFIG = {
  WINDOW: {
    DEFAULT_WIDTH: 550,
    DEFAULT_HEIGHT: 750,
    TITLE_PREFIX: "Gage Trade",
  },
  UPDATE_CHECK_INTERVAL: 4 * 60 * 60 * 1000, // 4 hours
  CLIPBOARD_CHECK_INTERVAL: 100,
  THROTTLE_DELAY: 1000,
...
const setupClipboardWatcher = () => {
  ...
  }, CONFIG.CLIPBOARD_CHECK_INTERVAL);
};
...
const setupTray = () => {
  ...
  tray.setToolTip(`${CONFIG.WINDOW.TITLE_PREFIX} - ${app.getVersion()}`);
